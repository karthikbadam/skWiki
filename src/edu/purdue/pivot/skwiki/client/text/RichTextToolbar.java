...
public class RichTextToolbar extends Composite {
	...
	public RichTextToolbar(RichTextArea richText) {
		...
		topPanel.setWidth(130 + "px");
		bottomPanel.setWidth(130 + "px");
	...
	private PushButton createPushButton(AbstractImagePrototype img, String tip) {
		...
		pb.getElement().getStyle().setDisplay(Style.Display.INLINE);
		pb.setStyleName("gwt-ButtonWidget2");
	...
	private ToggleButton createToggleButton(AbstractImagePrototype img,
		...
		tb.getElement().getStyle().setDisplay(Style.Display.INLINE);
		tb.setStyleName("gwt-ButtonWidget2");
